...
INSERT INTO patients (name, date_birth, kind_id, breed_id) VALUES
('Пес', '2021-7-13', 1, 1),
('Мотильда', '2021-7-22', 2, 16),
('Рыжик', '2021-8-17', 2, 15),
('Томат', '2021-1-11', 1, 5);
...
INSERT INTO orders (data, comment, procedure_id, user_id, patient_id) VALUES
('2024-7-13', 'Все прошло нормально', 2, 1, 1),
('2024-7-22', 'Все прошло нормально', 1, 2, 2),
('2024-8-17', 'Все прошло нормально', 5, 3, 3),
('2024-1-11', 'Все прошло нормально', 19, 4, 4);